...
{
    /// <summary>
    /// specifies a logical color space, which can be defined by a color profile
    /// file with a name consisting of Unicode 16-bit characters.
    /// [MS-WMF] 2.2.2.12
    /// </summary>
    public class LogColorSpaceW : ObjectBase
    {
        ...
        /// <summary>
        /// An optional, null-terminated Unicode UTF16-LE character string, which
        /// specifies the name of a file that contains a color profile.
        /// If a file name is specified, and the ColorSpaceType field is set to
