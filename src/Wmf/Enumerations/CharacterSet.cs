...
{
    /// <summary>
    /// Defines the possible sets of character glyphs that are defined in fonts for
    /// graphics output.
    /// [MS-WMF] 2.1.1.5
    /// </summary>
    public enum CharacterSet
    {
        ...
        /// <summary>
        /// Specifies a character set based on the current system locale; for example,
        /// when the system locale is United States English, the default character
        /// set is ANSI_CHARSET.
        /// </summary>
        ...
        /// <summary>
        /// Specifies the "traditional" Chinese character set, used mostly in Taiwan
