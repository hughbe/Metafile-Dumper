...
{
    /// <summary>
    /// Specifies printer driver functionality that might not be directly accessible
    /// through WMF records defined in the RecordType Enumeration (section 2.1.1.1).
    /// [MS-WMF] 2.1.1.17
    /// </summary>
    public enum MetafileEscapes
    {
        ...
        /// <summary>
        /// Queries a printer driver to determine whether a specific escape function is
        ...
        /// <summary>
        /// Retrieves the offset from the upper-left corner of the physical page where
        ...
        /// <summary>
        /// Sets the source, such as a particular paper tray or bin on a printer, for output
        /// forms.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves information concerning the sources of different forms on an output
        /// device.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves or specifies paper dimensions and other forms data on an output
        /// device.
        /// </summary>
        ...
        /// <summary>
        /// The same as STARTDOC specified with a NULL document and output filename,
        /// data in raw mode, and a type of zero
        /// </summary>
        OPEN_CHANNEL = 0x100E,
        ...
        /// process this data only when in PostScript mode. See POSTSCRIPT_IDENTIFY.
        /// </summary>
        ...
        /// The input MUST be a 32-bit quantity specifying the number of bytes to inject,
        /// a 16-bit quantity specifying the injection point, and a 16-bit quantity
        /// specifying the page number, followed by the bytes to inject.
        /// </summary>
        ...
        /// <summary>
        /// Gets information on a specified feature setting for a PostScript printer
        /// driver.
        /// </summary>
        ...
        /// <summary>
        /// Enables applications to include private procedures and other arbitrary data in
        /// documents.
        /// </summary>
